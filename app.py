...
# السر هنا: نقوم بتعريف المفاتيح (keys) مباشرة في الذاكرة إذا لم تكن موجودة
...
st.caption("تم إصلاح الكود: المعطيات لن تختفي عند عمل Refresh للمتصفح")
...
# --- واجهة الإدخال ---
# ملاحظة: عند استخدام 'key' في Streamlit، فإنه يربط القيمة بـ st.session_state[key] تلقائياً
...
# --- الحسابات المنطقية ---
# الآن نستخدم المتغيرات التي تم استخراجها مباشرة من المدخلات
